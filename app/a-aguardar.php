...
if ($updateEstadoStmt->affected_rows > 0) {
    ...
    header("Location: /labrats/app/visualizar-experiencia.php?Experiencia_ID=$experienciaId&status=reset");
} else {
    // Redirecionar com uma mensagem de erro
    header("Location: /labrats/app/visualizar-experiencia.php?Experiencia_ID=$experienciaId&status=error");
}
